...
public sealed class HouseRentDbContext : BaseCommandDbContext
{
    private readonly IPublisher _publisher;

    public HouseRentDbContext(DbContextOptions options, IPublisher publisher) : base(options)
    {
        _publisher = publisher;
    }
    public HouseRentDbContext(DbContextOptions options) : base(options)
    {
